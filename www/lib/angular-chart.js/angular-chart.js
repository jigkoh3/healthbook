(function () {
  ...
  function chart (type) {
    return {
      ...
      link: function (scope, elem/*, attrs */) {
        ...
        scope.$watch('setcolor', resetChart, true);
  ...
  function createChart (type, scope, elem) {
    ...
    var data = Array.isArray(scope.data[0]) ?
      getDataSets(scope.labels, scope.data, scope.series || [], scope.colours, scope.setcolor) :
  ...
  function getDataSets(labels, data, series, colours, setcolor) {
      var x = 1;
    return {
      labels: labels,
      datasets: data.map(function (item, i) {
          var dataSet = angular.copy(colours[setcolor[i]]);
